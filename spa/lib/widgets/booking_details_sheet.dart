...
class _BookingDetailsSheetState extends State<BookingDetailsSheet> {
  ...
  Future<void> _submit() async {
    ...
    final price = double.parse(
        priceText); // Используем parse вместо tryParse, так как валидатор уже проверил
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                // Поле спа-терапевта
                _buildSectionLabel('Спа-терапевт (необязательно)'),
                const SizedBox(height: 10),
                TextFormField(
                  controller: _masterController,
                  decoration: _buildInputDecoration(
                    hint: 'Имя спа-терапевта или специалиста',
